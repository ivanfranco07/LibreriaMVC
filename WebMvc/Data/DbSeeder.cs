            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            if (!context.Autores.Any())
            {
                var autores = new[]
                {
                    ...
                    new Autor { Nombre = "Fiódor",       Apellido = "Karamazov",        ListaLibros = new List<Libro>() },
            ...
            // 3) Libros - Datos sincronizados con la BBDD
            if (!context.Libros.Any())
            {
                var libros = new List<Libro>
                {
                    new Libro
                    {
                        ...
                        Precio = 18.75,
                        UrlImagenTapa = "https://ia601701.us.archive.org/view_archive.php?archive=/4/items/l_covers_0011/l_covers_0011_26.zip&file=0011260565-L.jpg",
                        Sinopsis = "Una distopía sobre el totalitarismo y la vigilancia del Estado.",
                        Idioma = "Español",
                        FechaPublicacion = new DateTime(1949, 8, 6),
                    ...
                    new Libro
                    {
                        ...
                        Precio = 26,
                        UrlImagenTapa = "https://ia600103.us.archive.org/view_archive.php?archive=/4/items/olcovers11/olcovers11-L.zip&file=111128-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        Precio = 22,
                        UrlImagenTapa = "https://ia800100.us.archive.org/view_archive.php?archive=/5/items/l_covers_0012/l_covers_0012_48.zip&file=0012489722-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        Precio = 15.5,
                        UrlImagenTapa = "https://ia801909.us.archive.org/view_archive.php?archive=/31/items/l_covers_0013/l_covers_0013_02.zip&file=0013028546-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        Precio = 17,
                        UrlImagenTapa = "https://ia800801.us.archive.org/view_archive.php?archive=/6/items/olcovers83/olcovers83-L.zip&file=832622-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        Precio = 15.99,
                        UrlImagenTapa = "https://ia600505.us.archive.org/view_archive.php?archive=/35/items/l_covers_0014/l_covers_0014_40.zip&file=0014403679-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        CantidadDePaginas = 256,
                        Precio = 16.99,
                        UrlImagenTapa = "https://ia600100.us.archive.org/view_archive.php?archive=/5/items/l_covers_0012/l_covers_0012_46.zip&file=0012460599-L.jpg",
                    ...
                    new Libro
                    {
                        Nombre = "Fiodor Karamazov",
                        Isbn = "978-8420645155",
                        Editorial = "Alianza",
                        CantidadDePaginas = 1008,
                        Precio = 32,
                        UrlImagenTapa = "https://ia600404.us.archive.org/view_archive.php?archive=/33/items/l_covers_0010/l_covers_0010_45.zip&file=0010458920-L.jpg",
                        Sinopsis = "Las tensiones filosóficas y familiares entre los hermanos Karamazov.",
                        Idioma = "Español",
                        FechaPublicacion = new DateTime(1880, 11, 1),
                        ListaAutores = new List<Autor> { Aut("Karamazov") },
                        Categoria = Cat("No ficción")
                    },
                    new Libro
                    {
                    ...
                    new Libro
                    {
                        ...
                        Precio = 29.5,
                        UrlImagenTapa = "https://ia600907.us.archive.org/view_archive.php?archive=/30/items/olcovers10/olcovers10-L.zip&file=100172-L.jpg",
                        Sinopsis = "El poema épico de Homero sobre la guerra de Troya.",
                        Idioma = "Español",
                        FechaPublicacion = new DateTime(1800, 1, 1),
                        ListaAutores = new List<Autor> { Aut("") },
                        Categoria = Cat("No ficción")
                    },
                    new Libro
                    {
                    ...
                    new Libro
                    {
                        ...
                        Precio = 18.99,
                        UrlImagenTapa = "https://covers.openlibrary.org/b/isbn/9780060935467-L.jpg",
                    ...
                    new Libro
                    {
                        ...
                        Precio = 13.99,
                        UrlImagenTapa = "https://ia801600.us.archive.org/view_archive.php?archive=/10/items/olcovers645/olcovers645-L.zip&file=6456720-L.jpg",
