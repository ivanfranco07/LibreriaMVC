...
namespace WebMvc.Migrations
{
    ...
    [Migration("20260618232608_FixCategoriaIdNaming")]
    partial class FixCategoriaIdNaming
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMvc.Models.Favorito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMvc.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebMvc.Models.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebMvc.Models.Favorito", b =>
                {
                    b.HasOne("WebMvc.Models.Libro", "Libro")
                        .WithMany()
                        .HasForeignKey("LibroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebMvc.Models.Usuario", "Usuario")
